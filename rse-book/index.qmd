...
::: {.callout-note}
This page summarises Nordic findings from the International RSE Survey 2026.
See the [User Guide](about/user-guide.qmd) for how the book is organised, and
the following parts for question-by-question tables and figures.
:::
